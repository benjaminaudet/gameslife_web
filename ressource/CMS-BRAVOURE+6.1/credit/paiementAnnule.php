        ...
        <div class="container">
          ...
          <div class="section-title">		
	        ...
	        <?php if (isset($_SESSION['utilisateur'])){?> 				
	        	<div class="jumbotron">
		        	<h4 class="alert-heading">Erreur lors de l'achat du produit .</h4>
		        	<p>
		     		Votre paiement a été refusé. Vous n'avez pas payé. Vous vous êtes trompé. Si le problème persiste contactez le support.</p><p>
		    		<a href="../support/" class="btn btn-secondary btn-thicker space">Support Client</a> <a href="../credit/" class="btn btn-default btn-thicker space">Recommencer</a>
		        	</p>
		        </div>
			<?php
			}
