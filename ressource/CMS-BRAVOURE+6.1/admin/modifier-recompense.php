...
session_start();
  ...
  if(isset($_SESSION['admin']) && !empty($_SESSION['admin'])) 
  {
    ...
    $serveur = 'f';
    $str=$bdd->prepare("SELECT * FROM probabilites WHERE id = :id"); // on prépare notre requête
                ...
                <br><article class="col-sm-6">
                    <?php include 'doc/situation.php'; ?>
                        ...
                        <div class="jarviswidget jarviswidget-sortable">
                                ...
                                <header role="heading">
                                    <h2>Modifier recompense - <?php echo $resultats->nom; ?></h2>
                                </header>
                                ...
                                <div role="content">
                                    ...
                                    {
                                        $req = $bdd->prepare('UPDATE probabilites SET nom=:nom,p=:p,commande=:commande,serveur=:serveur,quantite=:quantite WHERE id=:id');
                                    ...
                                    ?>
                                            <div class="alert alert-success alert-block">
                                                ...
                                                <h4 class="alert-heading">Succès :</h4>
                                                 L'item <b><?php echo $_POST['item']; ?></b> a été modifié avec succès.
                                            </div>
                                    <?php
                                    }
                                    ?>
                                        ...
                                        <form action="#" class="smart-form" method="post">
                                            ...
                                            <fieldset>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" name="item" id="basicround" value="<?php echo $resultats->nom; ?>">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" name="q" id="basicround" value="<?php echo $resultats->quantite; ?>">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" name="p" id="basicround" value="<?php echo $resultats->p; ?>">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    ...
                                                    <label class="input">
                                                        <input type="text" name="commande" id="basicround" value="<?php echo $resultats->commande; ?>">
                                                    </label>
                                                </section>
                                            ...
                                            <footer>
                                                <button type="submit" class="btn btn-primary" name="submit">Modifier</div>
                                            </footer>
