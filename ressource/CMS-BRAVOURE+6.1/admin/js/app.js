...
$(document).ready(function() {
	...
	$('#refresh').click(function(e) {
		$.SmartMessageBox({
			title : "<i class='fa fa-refresh' style='color:green'></i> Effacer stockage local",
			content : "Êtes-vous sûr d'effacer le contenu en local ?",
			buttons : '[No][Yes]'
	...
	$('#logout a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Déconnecter la session <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : "Une fois déconnecté, vous devrez vous reconnecter pour accèder au panel d'administration.",
			buttons : '[No][Yes]'
