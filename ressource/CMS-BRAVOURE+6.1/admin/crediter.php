...
session_start();
  ...
  set_session($bdd);
  $titre = 'Ajouter des points boutique';
  //----------------------------------//
					...
					<?php include 'doc/situation.php'; ?>
						...
						<div class="jarviswidget col-sm-4" style="margin-right:25px;">
									...
									<div class="widget-body">
										...
										?>
			                                    <div class="alert alert-success alert-block">
			                                       ...
			                                       Les points ont bien été ajoutés.</b>
			                                    </div>
										<?php
											}
										}
										...
										<form action="" method="post" class="smart-form">
											...
											<footer>
												<input type="submit" class="btn btn-primary" value="Créditer le joueur" name="submit">
							...
							<div class="jarviswidget col-sm-6">
								...
								<header role="heading">
									<h2>Ajouter des points à tous les joueurs</h2>
								</header>
								...
								<div role="content">
									...
									<div class="widget-body">
										...
										<form action="" method="post" class="smart-form">
											...
											<footer>
												<input type="submit" class="btn btn-primary" value="Créditer tous joueurs" name="all">
