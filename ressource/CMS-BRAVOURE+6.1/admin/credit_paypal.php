						...
						<div class="jarviswidget">
								...
								<div role="content">
									...
									<div class="widget-body">
 										<table class='table table-striped dataTable table-bordered'>
											<thead>
                                                <tr>
                                                  ...
                                                  <th style="width:15%">Numéro de transaction</th>
                                                </tr>
											</thead>
											<tbody>
											<?php
									        $query = $bdd->prepare('SELECT COUNT(*) FROM paypal');
					                        $query->execute();
                                            ...
                                            $requete = $bdd->prepare('SELECT * FROM paypal  ORDER BY id DESC LIMIT '.$start.', '.$epp.'');
                                            $requete->execute();
                                                ...
                                                while($resultats = $requete->fetch(PDO::FETCH_OBJ))
                                                {
                                                    echo '<tr>';
                                                    	...
                                                    	echo ' <td>'.$resultats->offre.'</td>';
                                                    	echo ' <td>'.$resultats->transaction_number.'</td>';
                                                    echo '</tr>';
                                                }
                                             ?>
											</tbody>
										...
										<?php echo paginate('paypal.php', '?p=', $nbPages, $current);?>
									</div>
									<!-- end widget content -->
