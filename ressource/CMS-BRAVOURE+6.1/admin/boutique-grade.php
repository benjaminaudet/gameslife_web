				...
				<br><article class="col-sm-12">
					<?php include 'doc/situation.php'; ?>
						...
						<div class="jarviswidget jarviswidget-sortable">
								...
								<header role="heading">
									<h2>Ajouter un grade progressif</h2>
								</header>
									...
									<div class="widget-body">
										...
										<form action="" class="smart-form" method="post" onsubmit="editor.post()">
											<header>
												...
												<?php
													$getAllGroups = $connexion_1->call("permissions.getAllGroups");
													$test = $getAllGroups["success"];
												?>
											<fieldset>
												...
												<section class="col col-3">
													<label class="label">Grade nécessaire</label>
